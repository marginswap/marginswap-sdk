...
export class Currency {
  ...
  public static getNativeCurrency(chainId?: ChainId): Currency | undefined {
    if (!chainId) {
  ...
  public static getNativeCurrencySymbol(chainId?: ChainId): string | undefined {
    const nativeCurrency = this.getNativeCurrency(chainId);
    return nativeCurrency?.symbol;
  }

  public static getNativeCurrencyName(chainId?: ChainId): string | undefined {
    const nativeCurrency = this.getNativeCurrency(chainId);
    return nativeCurrency?.name;
  }

  public getSymbol(chainId?: ChainId): string | undefined {
    if (!chainId) {
      return this?.symbol;
    }
  ...
  public getName(chainId?: ChainId): string | undefined {
    if (!chainId) {
      return this?.name;
    }
